    ...
    const commit = vi
      ...
      .mockResolvedValue({
        final_turning_points: [
          ...
          { id: 22, point_date: "2024-01-04", point_type: "trough", point_price: 8.8, source_type: "manual" },
        ],
